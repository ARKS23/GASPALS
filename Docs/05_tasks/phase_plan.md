...
> 本文档已于 2026-07-28 停止作为项目执行路线，仅保留早期原型决策的历史记录。
>
> 当前项目方向是“魂类近战为核心、枪械为可获得战斗方式”，请以 [混合战斗 GAS 路线图](../List/hybrid_combat_gas_roadmap.md) 为准。
>
> 文中的 `UHealthComponent`、`AWeaponBase` 和旧 HUD 状态已经被 GAS Vitals、`ANXRangedWeapon` 与原生 Combat HUD 架构取代；不得据此继续新增旧架构调用方。
